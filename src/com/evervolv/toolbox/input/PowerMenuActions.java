...
public class PowerMenuActions extends SettingsPreferenceFragment {
    ...
    private void getUserConfig() {
        ...
        String savedActions = EVSettings.Secure.getStringForUser(mContext.getContentResolver(),
                EVSettings.Secure.POWER_MENU_ACTIONS, UserHandle.USER_CURRENT);
    ...
    private void saveUserConfig() {
        ...
        EVSettings.Secure.putStringForUser(getContentResolver(),
                EVSettings.Secure.POWER_MENU_ACTIONS, s.toString(), UserHandle.USER_CURRENT);
        updatePowerMenuDialog();
    }

    private void updatePowerMenuDialog() {
        Intent u = new Intent();
        u.setAction(evervolv.content.Intent.ACTION_UPDATE_POWER_MENU);
