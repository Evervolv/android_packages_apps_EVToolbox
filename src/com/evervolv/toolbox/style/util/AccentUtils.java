 ...
 */
package com.evervolv.toolbox.style.util;
...
import com.evervolv.toolbox.style.models.Accent;
import com.evervolv.toolbox.style.models.StyleStatus;
...
public final class AccentUtils {
    ...
    private static final String METADATA_COLOR = "berry_accent_preview";
    private static final String METADATA_SUPPORTED_STYLES = "berry_accent_supported_styles";
    ...
    private static Accent getDefaultAccent(Context context) {
        return new Accent(context.getString(R.string.style_accent_default_name),
                StyleInterface.ACCENT_DEFAULT, Color.parseColor("#008577"), StyleStatus.DYNAMIC);
    }
