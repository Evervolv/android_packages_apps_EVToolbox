...
public class UpdatesRelease extends UpdatesFragment implements OnPreferenceChangeListener {

    private static final String AVAILABLE_UPDATES_CAT = "pref_updates_release_category_available_updates";
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mCheckUpdates) {
            ...
            sPrefs.edit().putInt(Constants.PREF_UPDATE_SCHEDULE_RELEASE,
                    value).apply();
    ...
    protected String getUpdateCheckAction() {
        return UpdateManifestService.ACTION_UPDATE_CHECK_RELEASE;
    }
