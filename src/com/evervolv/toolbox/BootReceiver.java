...
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context ctx, Intent intent) {
        ...
        if (FileUtil.fileExists(MemoryManagement.KSM_RUN_FILE)) {
    ...
    private void configureCPU(Context ctx) {
        ...
        String availableFrequenciesLine = FileUtil.fileReadOneLine(Processor.FREQ_LIST_FILE);
        String availableGovernorsLine = FileUtil.fileReadOneLine(Processor.GOV_LIST_FILE);
        ...
        if (noSettings) {
            ...
            if (minFrequency != null && frequencies != null && frequencies.contains(minFrequency)) {
                FileUtil.fileWriteOneLine(Processor.FREQ_MIN_FILE, minFrequency);
            }
