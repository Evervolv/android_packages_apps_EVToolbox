...
//                        Log.i(LOGTAG, data);
    ...
    void setContentView() {
        setContentView(R.layout.superuser_request);

        mSpinner = (Spinner)findViewById(R.id.remember_choices);
        mSpinner.setAdapter(mSpinnerAdapter = new ArrayAdapter<String>(this, R.layout.superuser_request_spinner_choice, R.id.request_spinner_choice));
