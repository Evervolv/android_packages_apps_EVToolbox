...
public class PartsSearchIndexablesProvider extends SearchIndexablesProvider {
    ...
    private static final String TAG = PartsSearchIndexablesProvider.class.getSimpleName();
    ...
    public Cursor queryXmlResources(String[] strings) {
        ...
        for (String key : keys) {
            ...
            ref[COLUMN_INDEX_XML_RES_ICON_RESID] = R.drawable.ic_launcher_evervolv;
            ref[COLUMN_INDEX_XML_RES_INTENT_ACTION] = i.getAction();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = PARTS_ACTIVITY.getPackageName();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_CLASS] = PARTS_ACTIVITY.getClassName();
            cursor.addRow(ref);
        }
        return cursor;
        ...
        for (String key : keys) {
            ...
            for (SearchIndexableRaw raw : rawList) {
                ...
                ref[COLUMN_INDEX_RAW_ICON_RESID] = raw.iconResId > 0 ? raw.iconResId :
                        (i.getIconRes() > 0 ? i.getIconRes() : R.drawable.ic_launcher_evervolv);
                ...
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_PACKAGE] = raw.intentTargetPackage != null ?
                        raw.intentTargetPackage : PARTS_ACTIVITY.getPackageName();
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_CLASS] = raw.intentTargetClass != null ?
                        raw.intentTargetClass : PARTS_ACTIVITY.getClassName();
