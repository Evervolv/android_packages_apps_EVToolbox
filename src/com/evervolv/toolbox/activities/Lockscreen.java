...
import com.evervolv.toolbox.utils.ColorPickerView;
...
public class Lockscreen extends SettingsFragment implements OnPreferenceChangeListener {
    ...
    private static final String LOCKSCREEN_BACKGROUND_PREF = "pref_lockscreen_background";
    ...
    private void updateLockBackgroundSummary() {
        ...
        if (value == -1) {
            ...
            resId = R.string.lockscreen_background_transparent;
