...
public class CustomSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String TOOLBOX_NS = NS_BASE + "com.evervolv.toolbox";
    private static final String ANDROIDNS = NS_BASE + "android";
    ...
    public CustomSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mMax = attrs.getAttributeIntValue(TOOLBOX_NS, "max", 100);
        mMin = attrs.getAttributeIntValue(TOOLBOX_NS, "min", 0);
        mDefaultValue = attrs.getAttributeIntValue(ANDROIDNS, "defaultValue", -1);
        mUnits = getAttributeStringValue(attrs, TOOLBOX_NS, "units", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(TOOLBOX_NS, "interval");
            if (newInterval != null)
