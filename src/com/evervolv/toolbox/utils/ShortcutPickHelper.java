...
public class ShortcutPickHelper {
    ...
    public ShortcutPickHelper(Fragment parent, OnPickListener listener) {
        mParent = parent;
        mListener = listener;
    }
    ...
    public void pickShortcut() {
        ...
        //I do not know if this is proper, but it works...
        shortcutIcons.add(ShortcutIconResource.fromContext(mParent.getActivity().getBaseContext(),
